export const getFlightsData = async (direction) => {
  let sweets = [
    {
      name: "Sooji Halwa",
...
export const getFlight = (selectedProductId) => {
  console.log(" ---selectedProductId---> ", selectedProductId);

  if (typeof selectedProductId !== "string") {
    return null; // or handle the case when selectedProductId is not a string
  }

  const selectedWords = selectedProductId?.split(" ");
  return allData.filter((flight) =>
    selectedWords?.some((word) => flight?.name?.toLowerCase().includes(word))
  )[0];
};
...
export const questionsData = [
  {
    ...
    answer:
      "Welcome! We offer a variety of lassi flavors including Rajavadi, Kesar Madhavi, Madhavi, and Mango Madhavi. Which would you like to try?",
  },
  {
    keyword: "lassi made",
    question: "what is lassi made of?",
    answer:
      "Lassi typically consists of yogurt, water or milk, sweeteners like sugar or honey, and flavorings such as fruit or spices. It's blended together to create a refreshing and creamy drink",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We offer dairy products like Lassi, Peda, Kesar Pista, Rich chocolate shake, Gulab jabun tin, Papdi, and all kinds of Namkeens",
  },
  {
    keyword: "sourcing",
    question: "Where do you source your dairy products from?",
    answer:
      "We take pride in sourcing our dairy products from trusted local suppliers known for their commitment to quality and ethical practices.",
  },
  {
    keyword: "quality control",
    question: "Can you tell me about your quality control measures?",
    answer:
      "We maintain rigorous quality control measures to uphold the highest standards for our products.",
  },
  {
    keyword: "organic",
    question: "Do you offer any organic or locally sourced options?",
    answer:
      "Yes, we are proud to offer organic and locally sourced options for many of our products.",
  },
  {
    keyword: "best selling",
    question: "What are your best-selling dairy products?",
    answer:
      "Our all-time most selling item is Thabadi Peda, Maramari Special Limited.",
  },
  {
    keyword: "artisanal",
    question: "Do you have any specialty or artisanal dairy items?",
    answer:
      "Our artisanal dairy products are crafted with passion and expertise by skilled artisans.",
  },
  {
    keyword: "freshness",
    question: "How do you ensure freshness and shelf-life of your products?",
    answer:
      "We prioritize freshness and quality in all our products by implementing strict sourcing, efficient logistics, state-of-the-art facilities, optimal storage, and regular inspections.",
  },
  {
    keyword: "allergens",
    question: "Are there any allergens present in your dairy products?",
    answer:
      "Yes, some of our products may contain allergens such as nuts, soy, or gluten, depending on the recipe or flavor.",
  },
  {
    keyword: "bulk purchasing",
    question: "Do you offer bulk purchasing options for businesses?",
    answer:
      "Yes, we offer bulk purchasing options for businesses and provide competitive pricing and tailored solutions.",
  },
  {
    keyword: "pricing",
    question: "Can you provide information on your pricing?",
    answer:
      "Our pricing varies depending on factors such as the product, quantity ordered, and any customization or special requests.",
  },
  {
    keyword: "promotions",
    question:
      "Do you have any current promotions or discounts on dairy products?",
    answer:
      "At the moment, we don't have any specific promotions or discounts on dairy products.",
  },
  {
  ...
  {
    keyword: "loyalty reward",
    question: "Do you offer loyalty rewards for frequent customers?",
    answer:
      "Yes, we offer a loyalty rewards program for frequent customers to earn points for every purchase they make.",
  },
  {
    keyword: "name",
  ...
  },
  {
    ...
    answer:
      "Email: care@madhvi.in, Location: Banas Dairy Rd, Chandralok Society, Shivam Nagar Society, Palanpur, Gujarat 385001, Contact: 9824051188",
  },
  {
    keyword: "location",
    question: "Show me the nearby location and merchant outlet",
    answer:
      "NEARBY LOCATION: Banas Dairy Rd, Chandralok Society, Shivam Nagar Society, Palanpur, Gujarat 385001",
  },
];
